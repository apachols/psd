...
def makePersons():
    bob = psd.register.models.Person(
            first_name = 'Bob',
            gender = 'M',
            age = 42,
            ...
            seek_kinkiness = 'EI',
            psdid = 'BOB1')
    lulu = psd.register.models.Person(
            first_name = "Lulu",
            gender = 'W',
            age = 42,
            ...
            seek_kinkiness = 'EI',
            psdid='LULU1')
    gayboy = psd.register.models.Person(
            first_name = 'gayboy',
            gender = 'M',
            age = 52,
            seeking_primary = True,
            ...
            seek_kinkiness = 'EI',
            psdid='GAYBOY1')
    omni1 = psd.register.models.Person(
            first_name="omni",
            gender = 'W,TW',
            age = 42,
            seeking_primary = False,
            ...
            seek_kinkiness = 'K',
            psdid='OMNI1')
    omni2 = psd.register.models.Person(
            first_name="omni2",
            gender = 'W,TW',
            age = 42,
            seeking_primary = False,
...
def makeTestEvent(event_name="testing1"):
    ...
    """
    return psd.register.models.Event( event=event_name, longname="Fake Testing Event", location="Nowhere", address="1010 Nowhere Ave", 
